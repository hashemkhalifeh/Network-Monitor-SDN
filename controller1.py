...
class ExampleSwitch13(app_manager.RyuApp):
    ...
    def add_layer4_rules(self, datapath, ip_proto, ipv4_dst = None, priority = 1, fwd_port = None, udp_dst = None):
        parser = datapath.ofproto_parser
    ...
    def _handle_udp(self, datapath, port, pkt):
        ...
        if src_ip == '10.0.0.1' and dst_ip == '10.0.0.2' :
          ...
          # Switch 3 rules
          self.add_layer4_rules(self.dp3, inet.IPPROTO_UDP, '10.0.0.2', 10, 2, udp_dst)
          self.add_layer4_rules(self.dp3, inet.IPPROTO_UDP, '10.0.0.1', 10, 1, udp_src)

          # Switch 1 rules
          self.add_layer4_rules(self.dp1, inet.IPPROTO_UDP, '10.0.0.2', 10, 2, udp_dst)
          self.add_layer4_rules(self.dp1, inet.IPPROTO_UDP, '10.0.0.1', 10, 1, udp_src)

          # Switch 4 rules
          self.add_layer4_rules(self.dp4, inet.IPPROTO_UDP, '10.0.0.2', 10, 1, udp_dst)
          self.add_layer4_rules(self.dp4, inet.IPPROTO_UDP, '10.0.0.1', 10, 2, udp_src)
        ...
        if src_ip == '10.0.0.1' and dst_ip == '10.0.0.3' :
          ...
          # Switch 3 rules
          self.add_layer4_rules(self.dp3, inet.IPPROTO_UDP, '10.0.0.3', 10, 2, udp_dst)
          self.add_layer4_rules(self.dp3, inet.IPPROTO_UDP, '10.0.0.1', 10, 1, udp_src)

          # Switch 1 rules
          self.add_layer4_rules(self.dp1, inet.IPPROTO_UDP, '10.0.0.3', 10, 3, udp_dst)
          self.add_layer4_rules(self.dp1, inet.IPPROTO_UDP, '10.0.0.1', 10, 1, udp_src)

          # Switch 5 rules
          self.add_layer4_rules(self.dp5, inet.IPPROTO_UDP, '10.0.0.3', 10, 1, udp_dst)
          self.add_layer4_rules(self.dp5, inet.IPPROTO_UDP, '10.0.0.1', 10, 2, udp_src)
        ...
        if src_ip == '10.0.0.2' and dst_ip == '10.0.0.3' :
          ...
          # Switch 4 rules
          self.add_layer4_rules(self.dp4, inet.IPPROTO_UDP, '10.0.0.3', 10, 2, udp_dst)
          self.add_layer4_rules(self.dp4, inet.IPPROTO_UDP, '10.0.0.2', 10, 1, udp_src)

          # Switch 1 rules
          self.add_layer4_rules(self.dp1, inet.IPPROTO_UDP, '10.0.0.2', 10, 2, udp_src)
          self.add_layer4_rules(self.dp1, inet.IPPROTO_UDP, '10.0.0.3', 10, 3, udp_dst)

          # Switch 5 rules
          self.add_layer4_rules(self.dp5, inet.IPPROTO_UDP, '10.0.0.3', 10, 1, udp_dst)
          self.add_layer4_rules(self.dp5, inet.IPPROTO_UDP, '10.0.0.2', 10, 2, udp_src)
